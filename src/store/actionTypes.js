...
export const SECOND_TOUCH_DOWN_ON_STAGE = "SECOND_TOUCH_DOWN_ON_STAGE";
export const SECOND_TOUCH_MOVED_ON_STAGE = "SECOND_TOUCH_MOVED_ON_STAGE";
export const SECOND_TOUCH_UP_ON_STAGE = "SECOND_TOUCH_UP_ON_STAGE";
